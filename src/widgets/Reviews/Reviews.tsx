...
function Reviews() {
    ...
    const reviews = [
        { id: 1, name: 'ФИО', vacation: 'специалист профессия', worker: 'фио кто отзывался', date: 'дата, место', comment: 'Текст отзыва', raiting: 4.8 },
        { id: 2, name: 'ФИО', vacation: 'специалист профессия', worker: 'фио кто отзывался', date: 'дата, место', comment: 'Текст отзыва', raiting: 4.8 },
        { id: 3, name: 'ФИО', vacation: 'специалист профессия', worker: 'фио кто отзывался', date: 'дата, место', comment: 'Текст отзыва', raiting: 4.8 },
        { id: 4, name: 'ФИО', vacation: 'специалист профессия', worker: 'фио кто отзывался', date: 'дата, место', comment: 'Текст отзыва', raiting: 4.8 },
    ];
            ...
            {isMobile ? (
                <div className={style.reviews_slider}>
                    <Swiper
                        spaceBetween={16}
                        slidesPerView={1.1}
                        grabCursor={true} // курсор захвата, как в About
                    >
                        {reviews.map((review) => (
                            <SwiperSlide key={review.id}>
                                <div className={style.reviews_item}>
                                    <div className={style.reviews_naming}>
                                        <img src="../fonTest5.png" alt="avatar" />
                                    ...
                                    <div className={style.reviews_about}>
                                        ...
                                        <p className={style.reviews_about_rev}>{review.comment}</p>
