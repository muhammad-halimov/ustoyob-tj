                    ...
                    <>
                        <div className={styles.list_item_content}>
                            <div className={styles.address_text}>
                                ...
                                <img
                                    src={`https://flagcdn.com/w20/${phone.countryCode === '+992' ? 'tj' : 'un'}.png`}
                                    alt={phone.countryCode === '+992' ? 'TJ' : 'International'}
                                ...
                                >
                                    <Marquee text={phone.phone || ''} alwaysScroll threshold={-10} />
                                </a>
                            </div>
                        </div>
                        {!readOnly && (
                            <div className={styles.list_item_actions}>
                                <button className={styles.copy_icon} onClick={() => handleCopy(phone.phone || '')} title={t('profile:copyBtn')}>
                                ...
                                <button className={styles.delete_icon} onClick={() => handleDelete(String(phone.id))} disabled={deletingId === String(phone.id)} title={t('profile:deleteBtn')}>
                                    {deletingId === String(phone.id)
