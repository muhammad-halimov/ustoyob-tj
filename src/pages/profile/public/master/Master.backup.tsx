...
//     };
//
//     // Открытие галереи отзывов
//     const openReviewGallery = (index: number) => {
//         // This will be handled inside ReviewsSection component
//         console.log('Opening review gallery at index:', index);
//     };
//
...
//                     onOpenReviewGallery={openReviewGallery}
