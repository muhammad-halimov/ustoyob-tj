...
```tsx
import Address, { AddressValue, buildAddressData } from '../../../shared/ui/Address';
...
```tsx
import { buildAddressData } from '../../../shared/ui/Address';
...
Компонент использует CSS модули. Все стили находятся в `Address.module.scss`.
